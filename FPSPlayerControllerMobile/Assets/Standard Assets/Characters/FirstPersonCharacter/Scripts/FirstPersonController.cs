...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        //Added a bool for the menu button
        private bool m_Menu;
        ...
        //Functions that will allow us to use the slider menu to adjust our speed as we see fit
        public void AdJustVerticalLookSpeed(float newSpeed)
        {
          m_VerticalLookSpeed = newSpeed;
        }
        public void AdJustHorizontallLookSpeed(float newSpeed)
        {
            m_HorizontalLookSpeed = newSpeed;
        }
    }
